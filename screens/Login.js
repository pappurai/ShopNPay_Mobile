...
import { StyleSheet, Text, View, KeyboardAvoidingView, TextInput,FlatList } from 'react-native'
    ...
    return (
        ...
        >
            ...
            <View style={styles.service} >
                <Text style={styles.agreement}>By continuing you agree the ShopNPay Software and Service Agreement</Text>
            </View>
            <View style={styles.textContainer}>
                <Button
                    label="Get Pin"  
